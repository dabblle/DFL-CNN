...
def train():
    ...
    wdir = os.path.join('weights', output_dir) # weights dir
    if not os.path.exists(wdir):
        os.mkdir(wdir)
        print('create folder {}'.format(wdir))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/lp.data', help='*.data path')
    parser.add_argument('--multi-scale', action='store_true', help='adjust (67% - 150%) img_size every 10 batches')
    parser.add_argument('--img-size', nargs='+', type=int, default=[352], help='train and test image-sizes')
